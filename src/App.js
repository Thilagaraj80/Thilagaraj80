    ...
    <div>
      ...
      <Grid container spacing ={2}>
        ...
        <FormControl className={classes.addcolor}>
          ...
          <RadioGroup onChange={(e) => updateState("gender", e.target.value)} row>
            <FormControlLabel
              value="male"
              control={<Radio />}
              label="Male"
        ...
        <FormControl fullWidth>
          ...
          >
            ...
            <MenuItem value={"Adhaar card"}>Adhaar Id</MenuItem>
        ...
        />
        <Box height="10px" />
        {data?.file && <img className={classes.img} src={data?.file} alt="" />}
        <Box height="10px" />
        <center>
